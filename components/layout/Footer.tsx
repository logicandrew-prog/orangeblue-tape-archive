...
export const Footer = () => {
  return (
    <footer className="footer-gradient text-accent-foreground bg-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/" className="text-sm text-accent-foreground/70 hover:text-primary transition-colors">
                Главная
              </Link>
              <Link href="/catalog" className="text-sm text-accent-foreground/70 hover:text-primary transition-colors">
                Каталог кассет
              </Link>
              <Link href="/catalogs" className="text-sm text-accent-foreground/70 hover:text-primary transition-colors">
                Печатные каталоги
              </Link>
              <Link href="/contact" className="text-sm text-accent-foreground/70 hover:text-primary transition-colors">
                Обратная связь
              </Link>
            </nav>
          </div>
