...
const navLinks = [
  { href: "/", label: "Главная" },
  { href: "/catalog", label: "Аудиокассеты" },
  { href: "/video-catalog", label: "Видеокассеты" },
  { href: "/catalogs", label: "Печатные каталоги" },
...
export const Header = () => {
  ...
  return (
    <header className="header-gradient sticky top-0 z-50 mt-0 pt-[20px] pb-[20px]">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20 pt-[30px] pb-0">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 group pb-[10px]">
            <motion.div
