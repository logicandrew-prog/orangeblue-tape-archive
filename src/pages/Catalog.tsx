...
const Catalog = () => {
  return <Layout>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4 border-input text-orange-50 bg-[#ede6de]">
          <h3 className="font-display text-2xl mb-8 bg-orange-50 text-center text-secondary">
