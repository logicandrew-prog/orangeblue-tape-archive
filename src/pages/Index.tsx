...
const Index = () => {
  ...
  return <Layout>
    ...
    {/* Audio Article: History (Dynamic or Static) */}
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{
            ...
            <img
              src={audioHistoryArticle?.image_url || "/Videocassette/Glavnaya/CompactCassettes1.jpg"}
              alt="Компакт-кассеты"
          ...
          {videoHistoryArticle ? (
            <>
              <h2 className="font-display text-4xl text-foreground mb-6 flex items-center gap-3">
                ...
                {videoHistoryArticle.title}
              </h2>

              <div className="flex justify-center mb-8">
                <img
                  src={videoHistoryArticle.image_url || "/Videocassette/Glavnaya/VHS_Cassette.jpg"}
                  alt="VHS кассета"
    ...
    {/* Video Article: Video8 (Dynamic or Static) */}
    <section className="py-16 bg-primary-foreground">
      <div className="container mx-auto px-4">
        <motion.article initial={{
          opacity: 0,
          ...
          {video8Article ? (
            <>
              ...
              <div className="mb-8">
                <img
                  src={video8Article.image_url || "/Videocassette/Glavnaya/Video8_sony-1995-1996-mp-120-1.jpg"}
                  alt="Video8 кассета"
