              ...
              .map((manufacturer, index) => (
                ...
                >
                  <Link
                    ...
                    className="tape-card block group h-full bg-[#ede5de]"
                  >
                    {/* Logo Area */}
                    <div
                      className="aspect-square overflow-hidden flex items-center justify-center p-4 bg-primary-foreground border-2 border-border border-solid"
                      style={{ backgroundColor: "#ffffff" }}
                    >
                      <LogoImage
                        src={manufacturer.logo}
                        alt={manufacturer.name}
                        fallbackText={manufacturer.name.charAt(0)}
                      />
                    </div>

                    {/* Content */}
                    <div className="p-3 border-border border-solid border-2 bg-border">
